...
namespace id408
{
  ...
  extern id408::sim_t* entry;
  extern id408::base_sim_t* test;
  extern id408::settings_t settings;
...
//! This opens up the id408 namespace
//! What is the consequence of opening up a namespace?
using namespace id408;
...
int main(int argc, char** argv)
{
  ...
  char title[50];
  sprintf(title, "id408 Base Code. Running on Box2D %d.%d.%d", b2_version.major, b2_version.minor, b2_version.revision);
